...
from bloxonednsconfig.models.config_forward_zone import ConfigForwardZone  # noqa: E501
...
class TestConfigForwardZone(unittest.TestCase):
    ...
    def testConfigForwardZone(self):
        ...
        # model = bloxonednsconfig.models.config_forward_zone.ConfigForwardZone()  # noqa: E501
        pass
