...
class HostApi(object):
    ...
    def host_list(self, **kwargs):  # noqa: E501
        ...
        Use this method to list DNS Host objects. A DNS Host object associates DNS configuration with hosts.  # noqa: E501
    ...
    def host_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ConfigListHostResponse',  # noqa: E501
    ...
    def host_read(self, id, **kwargs):  # noqa: E501
        """Read the DNS Host object.  # noqa: E501

        Use this method to read a DNS Host object. A DNS Host object associates DNS configuration with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.host_read(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.host_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.host_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def host_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Read the DNS Host object.  # noqa: E501

        Use this method to read a DNS Host object. A DNS Host object associates DNS configuration with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.host_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `host_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ConfigReadHostResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def host_update(self, id, body, **kwargs):  # noqa: E501
        """Update the DNS Host object.  # noqa: E501

        Use this method to update a DNS Host object. A DNS Host object associates DNS configuration with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.host_update(id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: An application specific resource identity of a resource (required)
        :param ConfigHost body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.host_update_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.host_update_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def host_update_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update the DNS Host object.  # noqa: E501

        Use this method to update a DNS Host object. A DNS Host object associates DNS configuration with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.host_update_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `host_update`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ConfigUpdateHostResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
